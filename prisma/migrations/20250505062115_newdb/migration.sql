...
-- AddForeignKey
ALTER TABLE `OutletQuantity` ADD CONSTRAINT `OutletQuantity_clientId_fkey` FOREIGN KEY (`clientId`) REFERENCES `Clients`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `OutletQuantity` ADD CONSTRAINT `OutletQuantity_productId_fkey` FOREIGN KEY (`productId`) REFERENCES `Product`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
